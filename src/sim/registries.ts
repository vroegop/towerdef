...
// Radii are 0.3× their original values (the old 0.2× shrink × a 1.5× "bigger enemies" bump). This
// drives the body for rendering AND for sim collision, hero-contact distance, and the bullet hit
// window (e.r + bullet.r) — so a foe's hitbox always matches the size it draws at.
...
export const TYPES: Record<string, EnemyTypeDef> = {
  melee: { shape: 'square', behavior: 'stick', color: '#ff6b6b', hp: 1, dmg: 1, speed: 46, range: 0, r: 3.3, mass: 1, coinValue: 1 },
  ranged: { shape: 'triangle', behavior: 'bounce', color: '#4aa8ff', hp: 1, dmg: 1, speed: 46, range: 150, r: 3.3, mass: 1, coinValue: 2 },
  boss: { shape: 'hexagon', behavior: 'stick', color: '#e64cff', hp: 20, dmg: 3, speed: 9.2, range: 0, r: 6.6, mass: 1, coinValue: 5 },
  fast: { shape: 'diamond', behavior: 'stick', color: '#37d7ff', hp: 1, dmg: 0.6, speed: 92, range: 0, r: 2.7, mass: 1, coinValue: 2 }, // swarm → attack speed / multishot
  tank: { shape: 'square', behavior: 'stick', color: '#ffb3d1', hp: 5, dmg: 1.6, speed: 23, range: 0, r: 5.1, mass: 1, coinValue: 4 }, // wall → raw damage / amp
  splitter: { shape: 'pentagon', behavior: 'stick', color: '#ff8a33', hp: 2, dmg: 1, speed: 40, range: 0, r: 3.9, mass: 1, splits: 4, coinValue: 4 }, // → AoE (not spawned by waves; kept for the split mechanic)
};
